...
#
# Created: Tue Jun  7 17:51:26 2022
...
class Ui_STARRS(object):
    def setupUi(self, STARRS):
        ...
        self.chbTranscripts = QtGui.QCheckBox(self.splitter_13)
        ...
        self.btnSetTranscripts = QtGui.QPushButton(self.splitter_13)
        ...
        self.btnGetPendingApplicants = QtGui.QPushButton(self.tab_2)
        ...
        self.verticalLayout_6.addWidget(self.btnGetPendingApplicants)
        self.splitter_26 = QtGui.QSplitter(self.tab_2)
        ...
        self.tabApplicantData.setMaximumSize(QtCore.QSize(16777215, 120))
        ...
        self.splitter_14 = QtGui.QSplitter(self.groupBox_2)
        ...
        self.verticalLayout_8.addWidget(self.splitter_14)
        self.btnMadeDecision = QtGui.QPushButton(self.groupBox_2)
        self.btnMadeDecision.setMinimumSize(QtCore.QSize(0, 45))
        self.btnMadeDecision.setObjectName("btnMadeDecision")
        self.verticalLayout_8.addWidget(self.btnMadeDecision)
    ...
    def retranslateUi(self, STARRS):
        ...
        self.groupBox_4.setTitle(QtGui.QApplication.translate("STARRS", "Review Application", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton.setText(QtGui.QApplication.translate("STARRS", "PushButton", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_2.setTitle(QtGui.QApplication.translate("STARRS", "Make Decision", None, QtGui.QApplication.UnicodeUTF8))
