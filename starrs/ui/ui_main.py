...
class Ui_STARRS(object):
    def setupUi(self, STARRS):
        ...
        self.verticalLayout_6.addWidget(self.splitter_13)
        self.btnAddStudentData = QtGui.QPushButton(self.tab_2)
        self.btnAddStudentData.setMinimumSize(QtCore.QSize(0, 45))
        self.btnAddStudentData.setObjectName("btnAddStudentData")
        self.verticalLayout_6.addWidget(self.btnAddStudentData)
    ...
    def retranslateUi(self, STARRS):
        ...
        self.label_11.setText(QtGui.QApplication.translate("STARRS", "email", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_2.setTitle(QtGui.QApplication.translate("STARRS", "Prior Degrees", None, QtGui.QApplication.UnicodeUTF8))
        self.label_7.setText(QtGui.QApplication.translate("STARRS", "1) Degree | Year | GPA | University ", None, QtGui.QApplication.UnicodeUTF8))
        self.label_8.setText(QtGui.QApplication.translate("STARRS", "2) Degree | Year | GPA | University ", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label.setText(QtGui.QApplication.translate("STARRS", "Received transcript | recomendations", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.btnMadeDecision.setText(QtGui.QApplication.translate("STARRS", "DOOM", None, QtGui.QApplication.UnicodeUTF8))
